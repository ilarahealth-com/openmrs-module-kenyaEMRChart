...
-- ------------ create table etl_mch_enrollment-----------------------
  ...
  CREATE TABLE kenyaemr_etl.etl_mchs_delivery (
    ...
    infant_one_name VARCHAR(255),
    infant_one_gender VARCHAR(10),
    infant_one_weight INT(11),
    infant_one_condition VARCHAR(255),
    infant_one_birth_with_deformity VARCHAR(10),
    infant_one_teo_given VARCHAR(11),
    infant_one_bf_within_one_hour VARCHAR(11),
    infant_one_apgar_score_1min  DOUBLE,
    infant_one_apgar_score_5min  DOUBLE,
    infant_one_apgar_score_10min DOUBLE,
    infant_two_name VARCHAR(255),
    infant_two_gender VARCHAR(10),
    infant_two_weight INT(11),
    infant_two_condition VARCHAR(255),
    infant_two_birth_with_deformity VARCHAR(10),
    infant_two_teo_given VARCHAR(11),
    infant_two_bf_within_one_hour VARCHAR(11),
    infant_two_apgar_score_1min  DOUBLE,
    infant_two_apgar_score_5min  DOUBLE,
    infant_two_apgar_score_10min DOUBLE,
    infant_three_name VARCHAR(255),
    infant_three_gender VARCHAR(10),
    infant_three_weight INT(11),
    infant_three_condition VARCHAR(255),
    infant_three_birth_with_deformity VARCHAR(10),
    infant_three_teo_given VARCHAR(11),
    infant_three_bf_within_one_hour VARCHAR(11),
    infant_three_apgar_score_1min  DOUBLE,
    infant_three_apgar_score_5min  DOUBLE,
    infant_three_apgar_score_10min DOUBLE,
    test_1_kit_name VARCHAR(50),
    test_1_kit_lot_no VARCHAR(50) DEFAULT NULL,
    test_1_kit_expiry DATE DEFAULT NULL,
    test_1_result VARCHAR(50) DEFAULT NULL,
